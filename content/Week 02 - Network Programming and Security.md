...
| **KeyStore**                             | A file (repo) that holds _your_ private keys and certificates (Identity).                                                                                                                                                          |                                                                                                                                                                                                             |
| **TrustStore**                           | A file that holds the _public keys_ (certificates) of the CAs you _trust_ (Verification).                                                                                                                                          |                                                                                                                                                                                                             |
| **Server Loop**                          | A server socket must sit in an infinite `while(true)` loop, calling `accept()` to handle incoming clients one by one.                                                                                                              |                                                                                                                                                                                                             |
